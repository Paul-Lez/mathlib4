...
theorem mdifferentiableWithinAt_iff_source_of_mem_maximalAtlas
    [ContMDiffManifoldWithCorners I 1 M] (he : e ∈ maximalAtlas I 1 M) (hx : x ∈ e.source) :
    MDifferentiableWithinAt I I' f s x ↔
...
theorem mdifferentiableWithinAt_iff_source_of_mem_source
    [ContMDiffManifoldWithCorners I 1 M] {x' : M} (hx' : x' ∈ (chartAt H x).source) :
    MDifferentiableWithinAt I I' f s x' ↔
...
theorem mdifferentiableWithinAt_iff_target_of_mem_source
    [ContMDiffManifoldWithCorners I' 1 M'] {x : M} {y : M'} (hy : f x ∈ (chartAt H' y).source) :
    MDifferentiableWithinAt I I' f s x ↔
...
variable [ContMDiffManifoldWithCorners I 1 M] [ContMDiffManifoldWithCorners I' 1 M']
