...
@[norm_cast]
lemma val_smul [SMul S R] [SMul S M] [IsScalarTower S R M] (r : S) (f : AdicCompletion I M) :
    (r • f).val = r • f.val := rfl

lemma val_smul_apply [SMul S R] [SMul S M] [IsScalarTower S R M] (r : S) (f : AdicCompletion I M)
    (n : ℕ) : (r • f).val n = r • f.val n := rfl
